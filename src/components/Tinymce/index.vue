...
export default defineComponent({
  ...
  setup(props, {attrs, slots, emit}) {
    ...
    const init = {
      ...
      content_css: '/tinymce/assets/skins/content/default/content.min.css',  //以css文件方式自定义可编辑区域的css样式，css文件需自己创建并引入
