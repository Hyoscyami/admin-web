    ...
    children: [
      {
        ...
        component: () => import('@/views/deferred-declaration/upload.vue'),
        meta: { title: '延后申报上传材料', icon: 'table' },
        hidden: true
      }
    ]
  },
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('@/views/laws-regulations/detail.vue'),
        meta: { title: '查看制度法规', icon: 'dashboard' }
      }
    ]
  },
  {
