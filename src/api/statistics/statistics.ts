...
export function revokeUnDeclareListExport(data: QueryBadDebtRevokeReq) {
  return request({
    url: '/statistics/revoke/unDeclareList/export',
    method: 'post',
    headers: {
      'Content-Type': 'application/json;charset=UTF-8'
    },
...
export function listRevokeYears() {
  return request({
    url: '/statistics/listRevokeYears',
    method: 'get'
  })
}
