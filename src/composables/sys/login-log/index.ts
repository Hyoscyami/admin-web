...
import { list } from '@/api/sys/login-log'
...
import { LoginLogVO } from '@/model/vo/LoginLogVO'
import { QueryLoginLogReq, useQueryLoginLogReq } from '@/model/req/query/QueryLoginLogReq'

// 初始化表格的对象
const initTable = useTable<LoginLogVO, QueryLoginLogReq>(useQueryLoginLogReq(20))
// 父机构表格数据
