...
import { fullStatusQuery as list } from '@/api/statistics/statistics'
...
import { useFullStatusQuery, useTaxDeductionColumns } from '../../../model/vo/TaxDeductionColumns'
...
// 单个债务人全状态查询 表格展示列
export const unDeclareColumns = reactive(useFullStatusQuery())
// 对话框展示
